...
public class TaskIntegrationTests extends IntergrationTest {
    @Test
    public void getAll() {
    ...
    public void changeStatus() {
        ...
        // change status
        final TaskChangeStatusRequest changeStatusRequest = new TaskChangeStatusRequest(TaskStatus.DONE);

        final ResponseEntity<Void> updateResponse = restTemplate.exchange(
                "/task/" + id + "/status",
                HttpMethod.PUT,
                new HttpEntity<>(changeStatusRequest),
                Void.class
        );
        Assertions.assertEquals(HttpStatus.OK, updateResponse.getStatusCode());
        ...
        Assertions.assertNotNull(getResponse.getBody());
        Assertions.assertEquals(id, getResponse.getBody().getId());
        Assertions.assertEquals(changeStatusRequest.getStatus(), getResponse.getBody().getStatus());
    }
    ...
    public void assign() {
        ...
        Assertions.assertNotNull(getResponse.getBody());
        Assertions.assertEquals(id, getResponse.getBody().getId());
        Assertions.assertEquals(assignStatusRequest.getProjectId(), getResponse.getBody().getProjectId());
    }
